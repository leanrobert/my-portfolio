...
const About = () => {
  return (
    <Layout className='md:py-20'>
      <div>
        <h2 className='text-2xl text-center font-bold md:text-3xl md:pb-4'>About <span className='text-orange-300'>Me</span></h2>

        <div className='flex justify-center py-4'>
          <img src={me} alt='Lean Robert' className='rounded-full h-28 w-28 border-[0.2rem] border-orange-300 md:h-40 md:w-40' />
        </div>

        <div className='flex flex-col items-center gap-2'>
          <h3 className='font-bold text-xl md:text-2xl md:py-6'>Software Developer &amp; Sysadmin</h3>
