...
const Projects = () => {
  return (
    <Layout>
      <h2 className='text-2xl text-center font-bold'>Some Projects</h2>

      <div className='border-[0.2rem] border-orange-300 rounded-xl py-4 px-6 my-4 flex flex-col items-center gap-4'>
